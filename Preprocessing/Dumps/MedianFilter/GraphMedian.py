...
data1 = np.load('MedianSubtract1.dumps')
data2 = np.load('MedianSubtract2.dumps')
data3 = np.load('MedianSubtract3.dumps')
data4 = np.load('MedianSubtract4.dumps')
data5 = np.load('MedianSubtract5.dumps')
data6 = np.load('MedianSubtract6.dumps')
