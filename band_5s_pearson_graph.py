...
pearson_band = np.load('band_5s_pearson.dump')
print "Dump loaded"
abs_val = []
zero = []
...
plt.savefig('sorted_band_5s_pearson.svg')
plt.show()
...
plt.ylabel('Correlation value')
# plt.xticks(range(64), labels)
plt.savefig('sorted_absolute_value_5s_full_pearson.svg')
plt.show()
